...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2020 at 01:27 AM
...
(74, 'Diego Leon', 'diego@gmail.com', 'diego ltda', 'clontarf 5', 876543287, 'Diego', '7b7a53e239400a13bd6be6c91c4f6c4e', 'y');
...
(79, 62, 'miguel angel ', '2020-08-13', '11:00:00 ', 'networking', '13 of Agust 11 a, ', '', '');
...
(202003, 87, 'Luke sky walker', '2020-08-28'),
...
--
ALTER TABLE `projects`
  MODIFY `project_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
COMMIT;
